...
import asia.lhweb.mapper.PetMapperAnnotation;
 ...
 * @date : 2023/9/15
 */
public class PetAnnotationMapperTest {
    ...
    public void getPetByUserld(){
        List<Pet> petByUserld = petMapperAnnotation.getPetByUserId(2);
        showPets(petByUserld);
    }
    @Test
    public void getPetByld(){
        Pet petByld = petMapperAnnotation.getPetByld(1);
